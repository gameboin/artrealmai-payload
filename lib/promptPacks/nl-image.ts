 ...
 */
export const NL_IMAGE_PACK = `Target family: nl-image. Still image. Natural-language prose for Flux, FLUX.2, Krea, and similar large image models.
...
120-360 words for a single subject. Past 360 only for multi-subject or typography jobs when needed.
...
Keep every person 21+ adult. No minors. No sex acts. R-rated wardrobe and exaggerated body shape are allowed. Write anatomy as form, cloth, and gravity — not a porn shot list.
